...
summary: <span style="font-size:120%;color:#117A65">**BMVC 2021**</span> <br> We show using ‘class-level’ language descriptions, that can be acquired with minimal annotation cost, can improve the few-short learning performance.
