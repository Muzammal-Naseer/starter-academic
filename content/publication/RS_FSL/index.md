...
summary: <span style="font-size:120%;color:#117A65">**BMVC 2021**</span> <br> We show that by using ‘class-level’ lan-guage descriptions, that can be acquired with minimal an-notation cost, we can improve the few-short learning performance.
