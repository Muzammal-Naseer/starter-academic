...
summary: <span style="font-size:120%;color:#117A65">**NeurIPS 2021**</span>, <span style="font-size:120%;color:#D35400">**Spotlight**</span> <br> We demonstrate favorable merits of ViTs over CNNs for occlusion handling, robustness to distributional shifts and patch permutations, automatic segmentation without pixel supervision, and robustness against adversarial patches and common corruptions. 
