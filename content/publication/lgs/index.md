...
summary: <span style="font-size:120%;color:#117A65">**WACV 2019**</span> <br> Adversarial Defense approach based on regularization of gradients in the input spance that is capabale to mitigate the effect of unconstrained adversarial patches.
