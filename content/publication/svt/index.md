...
summary: <span style="font-size:120%;color:#117A65">**CVPR 2022**</span> <br> We propose a computationally efficient and effective approach to match local and global spatiotemporal views for self-supervision of video transformer without the dependency of negative samples or dedicated memory banks.  
