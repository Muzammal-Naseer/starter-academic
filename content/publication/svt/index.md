...
summary: <span style="font-size:120%;color:#117A65">**CVPR 2022**</span> <span style="font-size:120%;color:#D35400">**Oral**</span> <br> We propose a simple, computationally efficient yet effective approach to match local and global spatiotemporal views for *Self-supervised Video Transformers* without the dependency of negative samples or dedicated memory banks. Owing to the flexibility of Transformer models, SVT supports slow-fast video processing within a single architecture using dynamically adjusted positional encodings and supports long-term relationship modeling along spatiotemporal dimensions.
